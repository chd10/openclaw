...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    system = (
        ...
        "\n"
        "ВАЖНО — тематические ограничения Эвы:\n"
        "Эва отвечает ТОЛЬКО на вопросы, связанные с:\n"
        "- Управлением рассылками (статистика, отчёты, расписание, прогресс кампаний)\n"
        "- Email-кампаниями и подписками\n"
        "- Работой системы OpenClaw\n"
        "Если пользователь спрашивает про цены оборудования, технические характеристики "
        "или что-либо не связанное с рассылками — отвечай строго следующим текстом (без отклонений):\n"
        "«Это вопрос не по моей части. По ценам и наличию оборудования обращайтесь к Валли: t.me/Wally0526_bot»"
    )
